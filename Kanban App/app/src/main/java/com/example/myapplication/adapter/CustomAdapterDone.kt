...
class CustomAdapterDone(val tasks:ArrayList<Task> , val context: Context, val tab:Int): RecyclerView.Adapter<CustomAdapterDone.ViewHolder>() {
    private lateinit var v:View
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        v = LayoutInflater.from(p0?.context).inflate(R.layout.recycler_view_item_done, p0, false)
        return ViewHolder(v)
    }
    ...
    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
        ...
        Log.e("task p1",tasks[p1].toString())
        ...
        p0.left.setOnClickListener(){
            ...
            db.collection("users").document(userId!!).get().addOnCompleteListener { it2 ->
                if (it2.isSuccessful) {
                    ...
                    var data = userData.get("done") as? java.util.ArrayList<HashMap<String, Any>>
